...
SVM_Model3=sklearn.svm.SVC(C=1, kernel='poly',degree=2,
...
#SVM CODE for IDF CountVectorizer
...
SVM_matrix_idf = confusion_matrix(Test2Labels, SVM_Model.predict(TestDF2))
print("\nThe confusion matrix is:")
print(SVM_matrix)
print("\n\n")

SVM_Model2.fit(TrainDF2, Train2Labels)
SVM_matrix2_idf = confusion_matrix(Test2Labels, SVM_Model2.predict(TestDF2))
...
SVM_matrix3_idf = confusion_matrix(Test2Labels, SVM_Model3.predict(TestDF2))
print("\nThe Poly IDF confusion matrix is:")
print(SVM_matrix3)
print("\n\n")
...
print("SVM prediction:\n", SVM_Model.predict(TestDF1L))
print("Actual:")
print(Test1LabelsL)

SVM_matrix_lie = confusion_matrix(Test1Labels, SVM_Model.predict(TestDF1L))
print("\nThe confusion matrix is:")
print(SVM_matrix)
print("\n\n")
...
SVM_Model2.fit(TrainDF1L, Train1Labels)
SVM_matrix2_lie = confusion_matrix(Test1LabelsL, SVM_Model2.predict(TestDF1L))

print("\nThe RBF confusion matrix is:")
print(SVM_matrix2)
print("\n\n")

SVM_Model3=sklearn.svm.SVC(C=1, kernel='poly',degree=9,

                           gamma="auto", verbose=True)
SVM_Model3.fit(TrainDF1, Train1Labels)
SVM_matrix3_lie = confusion_matrix(Test1LabelsL, SVM_Model3.predict(TestDF1L))
print("\nThe Poly confusion matrix is:")
print(SVM_matrix3)
print("\n\n")
...
print("SVM prediction:\n", SVM_Model.predict(TestDF2L))
print("Actual:")
print(Test2LabelsL)

SVM_matrix_lie_idf = confusion_matrix(Test2LabelsL, SVM_Model.predict(TestDF2L))
print("\nThe confusion matrix is:")
print(SVM_matrix)
print("\n\n")

SVM_Model2.fit(TrainDF2L, Train2LabelsL)
SVM_matrix2_lie_idf = confusion_matrix(Test2LabelsL, SVM_Model2.predict(TestDF2L))
...
SVM_matrix3_lie_idf = confusion_matrix(Test2LabelsL, SVM_Model3.predict(TestDF2L))
print("\nThe Poly IDF lie confusion matrix is:")
print(SVM_matrix3_lie_idf)
print("\n\n")