...
SVM_Model2=sklearn.svm.SVC(C=3
                           , kernel='rbf', degree=1, verbose=True, gamma="auto")
...
SVM_Model3=sklearn.svm.SVC(C=20, kernel='poly',degree=2, gamma="auto", verbose=True)
...
#LIES AND SLANDER
SVM_Model.fit(TrainDF1L, Train1LabelsL)
SVM_matrixle = confusion_matrix(Test1LabelsL, SVM_Model.predict(TestDF1L))
print("The linear confusion matrix for the DF Lie is:")
print_cm(SVM_matrixle,['True','False'])

SVM_Model2.fit(TrainDF1L, Train1LabelsL)
SVM_matrix2le = confusion_matrix(Test1LabelsL, SVM_Model2.predict(TestDF1L))
print("The radial confusion matrix for the DF Lie is:")
print_cm(SVM_matrix2le,['True','False'])

SVM_Model3.fit(TrainDF1L, Train1LabelsL)
SVM_matrix3le = confusion_matrix(Test1LabelsL, SVM_Model3.predict(TestDF1L))
print("The polynomial confusion matrix for the DF Lie is:")
print_cm(SVM_matrix3le,['True','False'])


SVM_Model.fit(TrainDF2L, Train2LabelsL)
SVM_matrixidf = confusion_matrix(Test2LabelsL, SVM_Model.predict(TestDF2L))
print("The linear confusion matrix for the IDF Lie is:")
print_cm(SVM_matrixidf,['True','False'])

SVM_Model2.fit(TrainDF2L, Train2LabelsL)
SVM_matrix2idf = confusion_matrix(Test2LabelsL, SVM_Model2.predict(TestDF2L))
print("The radial confusion matrix for the IDF Lie is:")
print_cm(SVM_matrix2idf,['True','False'])

SVM_Model3.fit(TrainDF2L, Train2LabelsL)
SVM_matrix3idf = confusion_matrix(Test2LabelsL, SVM_Model3.predict(TestDF2L))
print("The polynomial confusion matrix for the IDF Lie is:")
print_cm(SVM_matrix3idf,['True','False'])


SVM_Model.fit(TrainDF2, Train2Labels)
SVM_matrixidfse = confusion_matrix(Test2Labels, SVM_Model.predict(TestDF2))
print("The linear confusion matrix for the IDF sentiment is:")
print_cm(SVM_matrixidfse,['True','False'])

SVM_Model2.fit(TrainDF2, Train2Labels)
SVM_matrix2idfse = confusion_matrix(Test2Labels, SVM_Model2.predict(TestDF2))
print("The radial confusion matrix for the IDF sentiment is:")
print_cm(SVM_matrix2idfse,['True','False'])

SVM_Model3.fit(TrainDF2, Train2Labels)
SVM_matrix3idfse = confusion_matrix(Test2Labels, SVM_Model3.predict(TestDF2))
print("The polynomial confusion matrix for the IDF sentiment is:")
print_cm(SVM_matrix3idfse,['True','False'])